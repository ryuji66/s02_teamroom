...
def index():
    ...
    rows = db.execute("SELECT entries.*, languages.name FROM entries JOIN language_to_entry ON entries.entry_id = language_to_entry.entry_id JOIN languages ON language_to_entry.language_id = languages.language_id")
